...
public class SimpleSortedRangeList implements SortedRangeList {

    public static final Logger log = LoggerFactory.getLogger(SimpleSortedRangeList.class);
    ...
    public SimpleSortedRangeList(String name) {
        this.name = name;
        head.next = tail;
        tail.prev = head;
        size = 0;
